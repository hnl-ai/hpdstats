...
def correct_ethnicities(ethnicities):
    ...
    corrections = {
        ...
        "Hispanic": ["Hise", "Hisp", "Hispar", "Hispat", "Hispe",
            "Hispani", "Hispani:", "Hispanir", "Hispaniv"],
        "Other": ["Othe", "Othe!", "Othe:", "Other Pac. Isl", "Othe!",
            "Other Pac. Isl:", "Other P", "Other A", "Other Asian",
            "Other 4", "Other P."
        ],
        "Unknown": ["S", "K", "F", "H", "C", "Unkr", "Unkn", "Unknow"],
        "Indian": ["|Indian", "|Indiai", "India", "Indiai"],
        "Japanese": ["Jape", "Jap", "Jap:", "Jap<",
            "Japa", "Japane:", "Japan", "Japai", "Japanes"],
